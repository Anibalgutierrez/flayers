...
const imagesArray = [
  ...
  'https://via.placeholder.com/100?text=V',
  'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEjNgI5DWMoaVUyXRF98_ogJNSdCbpnlrev3qGv3AsMwxV6c4LI17UE4QkOHphroWda00jwpQg_fsW0hLfpi4sz2o6xdlt6FurYwuwCZlQIHTEmYCgxOyk2rU_xBQtTBT1DVMOhv8CoaF_GaILqTSuImFR4rBT9Ja6MuEEUbwV8hEZdry0bqGu-K87uZ/s1600/EscudoGuemes%2050.png',
  ...
  return (
    <Container>
      <Box minH="100vh" p={5} alignContent={'center'}>
        <Center>
          <Text as='b' fontSize="2xl" onClick={toggleDatePicker} cursor="pointer">
